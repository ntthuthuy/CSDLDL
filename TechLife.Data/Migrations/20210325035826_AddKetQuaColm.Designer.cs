...
namespace TechLife.Data.Migrations
{
    ...
    [Migration("20210325035826_AddKetQuaColm")]
    partial class AddKetQuaColm
    {
            ...
            modelBuilder.Entity("TechLife.Data.Entities.HoSoThanhTra", b =>
                {
                    ...
                    b.Property<DateTime>("NgayTao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 25, 10, 58, 23, 500, DateTimeKind.Local).AddTicks(875));
            ...
            modelBuilder.Entity("TechLife.Data.Entities.Log", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 25, 10, 58, 23, 249, DateTimeKind.Local).AddTicks(5882));
            ...
            modelBuilder.Entity("TechLife.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "32bb4c3b-2b39-46db-bc9e-b286db2a7d5e",
            ...
            modelBuilder.Entity("TechLife.Data.Entities.Tracking", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 25, 10, 58, 23, 241, DateTimeKind.Local).AddTicks(7421));
            ...
            modelBuilder.Entity("TechLife.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "20dc9554-d209-4058-bb8d-c1985f5c64e5",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECisiomDuPhtgRP8fp6qrW5GFqFSKLmou3ip3hX7supszpl/J8REQVKoqAAe6OO2Jw==",
