    ...
    public partial class RemoveProducts : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "IsDeleted", "IsShowOnHome", "Name", "ParentId", "SortOrder", "Status" },
                values: new object[,]
                {
                    { 1, false, true, "Cơ sở lưu trú", null, 1, true },
                    { 2, false, true, "Nhà hàng đạt chuẩn", null, 2, true }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "IsFeatured", "Name", "OriginalPrice", "Price" },
                values: new object[] { 1, new DateTime(2020, 11, 30, 9, 31, 3, 568, DateTimeKind.Local).AddTicks(5672), null, "Láp top DEL N9005", 100000m, 200000m });
