...
namespace TechLife.SSO
{
    ...
    {
        private static string Key = "5Pf9MXZdb439/oj5NJZpq3BmujQ=";
        ...
        public static void SetCookies(string cookie, string value)
        {
            try
            {
        ...
        public static string SetKeyCookie(string keyName, string value)
        {
            HttpContext.Current.Response.Cookies.Add(new HttpCookie(keyName, value));
            SetCookies(keyName, value);
            return value;
        }
        public static string GetKeyCookie(string keyName, string value)
        {
            string cookies = "";
            if (HttpContext.Current.Response.Cookies[keyName] == null)
            {
                SetCookies(keyName, cookies);
            }
            else
            {
                cookies = HttpContext.Current.Response.Cookies[keyName].Value;
            }
            return cookies;
        }
        public static void RemoveCookies(string cookie)
        {
            ...
            try
            {
                ...
                cookieset.Expires = DateTime.Now.AddYears(-1);
                HttpContext.Current.Response.Cookies.Remove(cookie);
                HttpCookie cookie2 = new HttpCookie(cookie, "") { Expires = DateTime.Now.AddYears(-1) };
